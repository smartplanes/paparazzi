...
#define GPS_PROTOCOL 5    // 1 - NMEA,  2 - EM406,  3 - Ublox, 4 -- MediaTek, 5- I2c
...
#define PRINT_I2C 1  // sends attitude message as slave over I2C
...
{ 
  ...
  // setup for I2C output
  if(PRINT_I2C) {
      Wire.begin(17);                // join i2c bus with address #2
      Wire.onRequest(requestEvent);
  }
  if (GPS_PROTOCOL == 5) {
       	// set up the I2c receive interrupt
